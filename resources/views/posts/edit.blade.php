...
<form 
    ...
    <div class="p-2 text-right">
        <a class="text-white bg-gradient-to-r from-green-500 to-teal-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2" href="{{ url()->previous() }}">Cancel</a>
